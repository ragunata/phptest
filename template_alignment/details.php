<!DOCTYPE html>
<!-- saved from url=(0084)details.html -->
...
<div class="inside-banner">
  <div class="container"> 
    <span class="pull-right"><a href="details.html#">Home</a> / Buy</span>
    <h2>Buy</h2>
</div>
</div>
<!-- banner -->
...
<div class="row">
                <div class="col-lg-4 col-sm-5"><img src="./images/4.jpg" class="img-responsive img-circle" alt="properties"></div>
...
<div class="row">
                <div class="col-lg-4 col-sm-5"><img src="./images/3.jpg" class="img-responsive img-circle" alt="properties"></div>
                <div class="col-lg-8 col-sm-7">
                  <h5><a href="details.html">Integer sed porta quam</a></h5>
                  <p class="price">$300,000</p> </div>
              </div>
...
<div class="row">
                <div class="col-lg-4 col-sm-5"><img src="./images/2.jpg" class="img-responsive img-circle" alt="properties"></div>
                <div class="col-lg-8 col-sm-7">
                  <h5><a href="details.html">Integer sed porta quam</a></h5>
                  <p class="price">$300,000</p> </div>
              </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <!-- Item 1 -->
        <div class="item">
          <img src="./images/4.jpg" class="properties" alt="properties">
        </div>
        <!-- #Item 1 -->

        <!-- Item 2 -->
        <div class="item active">
          <img src="./images/2.jpg" class="properties" alt="properties">
        ...
        <!-- Item 3 -->
         <div class="item">
          <img src="./images/1.jpg" class="properties" alt="properties">
        </div>
        <!-- #Item 3 -->

        <!-- Item 4 -->
        <div class="item ">
          <img src="./images/3.jpg" class="properties" alt="properties">
          
        </div>
        <!-- # Item 4 -->
      </div>
      <a class="left carousel-control" href="details.html#myCarousel" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span></a>
      <a class="right carousel-control" href="details.html#myCarousel" data-slide="next"><span class="glyphicon glyphicon-chevron-right"></span></a>
    </div>
<!-- #Slider Ends -->
...
<div class="well"><iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="./images/maps.html"></iframe></div>
  </div>
...
<div class="row">
            ...
            <div class="col-lg-3 col-sm-3">
                    <h4>Follow us</h4>
                    <a href="details.html#"><img src="./images/facebook.png" alt="facebook"></a>
                    <a href="details.html#"><img src="./images/twitter.png" alt="twitter"></a>
                    <a href="details.html#"><img src="./images/linkedin.png" alt="linkedin"></a>
                    <a href="details.html#"><img src="./images/instagram.png" alt="instagram"></a>
            </div>
