...
class Advertisments extends CI_Controller {
	...
	public function index($type = null, $page_num =1,$sortfield='id',$order='desc') 
	{
		...
		$data['comments'] = $this->advertisment_model->get_advertisments( 1 , $conditions, $sort_f, $order, $limit_start ,$limit_end);        
		$config['total_rows'] =$this->advertisment_model->get_advertisments( 0 , $conditions, '', '', '', ''); 
