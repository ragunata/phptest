...
?>
<div class="map_canvas" id="map_canvas" style="height: 250px;width: 100%;margin-top: 20px;border: 1px solid #ccc;padding: 5px;"  data-address="<?php echo $my_adress;?>"   data-title="<?php echo $result['name'];?>"></div>