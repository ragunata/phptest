	      		...
	      		<div class="widget ">
					...
					<div class="tabbable">
						...
						<?php
							...
							echo form_open_multipart(base_url().ADMIN.'/hotel_banners/add/'.$this->uri->segment(4).'?pagemode=index&modestatus=1&sortingfied=id&sortype=Desc&hbpagemode='.$this->input->get('hbpagemode').'&hbmodestatus='.$this->input->get('hbmodestatus').'&hbsortingfied='.$this->input->get('hbsortingfied').'&hbsortype='.$this->input->get('hbsortype'),$attributes);
						?>
							<fieldset>      
                               <div class="control-group">
								...
								<div class="control-group">
									<label for="inputError" class="control-label">Banner Image <span class="must">*</span><br /></label>
									<div class="controls">
								...
								<div class="control-group">
				  				...
				  				<div class="control-group">											
									...
									<label class="checkbox inline">
										<?php echo form_checkbox('is_deleted', '0', TRUE); ?> Active
									</label>
									</div> <!-- /controls -->				
								</div> <!-- /control-group -->
							  ...
							  <div class="form-actions">
								...
								echo anchor(base_url().ADMIN.'/hotel_banners/'.$pageredirect.'/'.$pageno.'/'.$fieldsorts.'/'.$typesorts.'/'.$this->uri->segment(4).'?hbpagemode='.$this->input->get('hbpagemode').'&hbmodestatus='.$this->input->get('hbmodestatus').'&hbsortingfied='.$this->input->get('hbsortingfied').'&hbsortype='.$this->input->get('hbsortype'),'Cancel',array('class'=>'btn','title'=>'Cancel')); ?>
							  </div>
							</fieldset>
      					<?php echo form_close(); ?>
							</div>
