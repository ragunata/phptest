					...
					<div class="tabbable">
						<div class="tab-pane" id="formcontrols">
 						<?php
							...
							echo form_open_multipart(base_url().ADMIN.'/offer_banner/edit/'.$this->uri->segment(4).'?pagemode=index&modestatus=1&sortingfied=id&sortype=Desc&hbpagemode='.$this->input->get('hbpagemode').'&hbmodestatus='.$this->input->get('hbmodestatus').'&hbsortingfied='.$this->input->get('hbsortingfied').'&hbsortype='.$this->input->get('hbsortype'),$attributes);
						?>
							<fieldset>     
							...
							<input type="hidden" id="" name="id" value="<?php echo $banner['id']; ?>" >
							 ...
							 echo anchor(base_url().ADMIN.'/offer_banners/'.$pageredirect.'/'.$pageno.'/'.$fieldsorts.'/'.$typesorts.'/'. $banner['offer_id'].'?hbpagemode='.$this->input->get('hbpagemode').'&hbmodestatus='.$this->input->get('hbmodestatus').'&hbsortingfied='.$this->input->get('hbsortingfied').'&hbsortype='.$this->input->get('hbsortype'),'Cancel',array('class'=>'btn')); ?>
							  </div>
							</fieldset>
      					<?php echo form_close(); ?>
							</div>
