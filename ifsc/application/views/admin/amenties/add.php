	      		...
	      		<div class="widget ">
					...
					<div class="widget-content">
						<div class="tabbable">
							...
							echo form_open_multipart(ADMIN.'/amenties/add?pagemode='.$this->input->get('pagemode').'&modestatus='.$this->input->get('modestatus').'&sortingfied='.$this->input->get('sortingfied').'&sortype='.$this->input->get('sortype'), $attributes);
							?>
								<fieldset>
									<br/>
									...
									<div class="control-group">											
									<label class="control-label" for="iconic_code">Iconic Class<span class="must">*</span></label>
										<div class="controls">
										<?php echo form_input(array('name'=>'iconic_code','class'=> 'span3','id'=>'iconic_code'),$this->input->post('iconic_code')); ?>
