							...
							<fieldset>
								...
								<div class="widget-content">
									...
									<div class="control-group">											
										...
										<div class="controls">
										<?php echo form_input(array('name'=>'add_lat','readonly'=>'readonly','id'=>'add_lat','class'=> 'span3','placeholder'=>'','value'=>set_value('add_lat', $this->input->post('add_lat') ? $this->input->post('add_lat') : $lat_value))); ?>
									...
									<div class="control-group">											
										...
										<div class="controls">
										<?php echo form_input(array('name'=>'add_long','readonly'=>'readonly','id'=>'add_long','class'=> 'span3','placeholder'=>'','value'=>set_value('add_lat', $this->input->post('add_lat') ? $this->input->post('add_lat') : $long_value))); 
										?>
