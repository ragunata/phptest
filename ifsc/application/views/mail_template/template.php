		   ...
		   <tr>
				<td align="center" valign="top">
					 <table width="550" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
						   <tr bgcolor="#ffffff;">
							   <td align="center" valign="top" style="border:1px solid #ccc;background:#000;padding:10px 20px"><?php echo anchor(base_url(), img(base_url().'assets/img/admin/logo.png')); ?></td>
							</tr>
							<?php echo $contents; ?>
							<tr><td style="padding-left:20px;padding-top:0px;padding-bottom:20px;padding-right:20px;border:1px solid #ccc;border-width:0px 1px 1px 1px;font:normal 12px Tahoma;">
